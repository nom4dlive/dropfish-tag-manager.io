...
# Nome dos arquivos
html_filepath = "tags_manager.html"
readme_filepath = "README.md"

# Conteúdo HTML completo do Gerenciador de Tags (Versão Holográfica/Futurista)
HTML_CONTENT = """
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
# Conteúdo do README (ajustado para GitHub Desktop)
README_CONTENT = f"""# DROPFISH TAGS MANAGER // HOLOGRAPHIC UI
...
try:
    ...
    print(f"Arquivo '{html_filepath}' (HTML) criado com sucesso.")
    
    with open(readme_filepath, "w", encoding="utf-8") as f:
        f.write(README_CONTENT)
    print(f"Arquivo '{readme_filepath}' (README) criado com sucesso.")
    
except Exception as e:
    print(f"Erro ao criar os arquivos: {e}")
    exit()

print("\n--- PRÓXIMOS PASSOS (PARA O GITHUB DESKTOP): ---")
print("1. **Crie o Repositório no GitHub Desktop** na pasta onde os arquivos foram salvos.")
print("2. Faça o Commit Inicial e **Publique o Repositório** (Publish repository).")
print("3. Siga as instruções no README para ativar o **GitHub Pages**.")
